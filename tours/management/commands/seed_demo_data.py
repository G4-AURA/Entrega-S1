...
class Command(BaseCommand):
    ...
    def _create_stops(self, rutas):
        ...
        datos_curiosos = {
            ...
            "Barrio Santa Cruz": {"titulo": "La sombra del laberinto", "texto": "Sus estrechas calles no sonCasualidad: fueron diseñadas así por los árabes para mantener a los viandantes siempre en la sombra huyendo del sol abrasador.", "tipo": "Dato Curioso"},
