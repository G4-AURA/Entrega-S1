...
- [x] Issue 168: pruebas de integración del endpoint tours:obtener_curiosidad_parada completadas en tours/tests/test_live_curiosidades.py.
...
- [x] Issue 146: pruebas de integración de recalculo GraphHopper completadas en rutas/tests/test_graphhopper_integration.py.
